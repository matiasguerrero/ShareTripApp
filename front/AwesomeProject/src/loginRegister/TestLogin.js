    ...
    >
      ...
      <View style={styles.bottomContainerRegister}>
        <TouchableOpacity
          ...
          style={[
            ...
            { backgroundColor: "rgb(74,122,246)" },
          ]}
        >
      ...
      >
        <Text
          style={[
            styles.buttonText,
            { color: "rgb(255, 255, 255)", fontSize: 15, fontFamily: "Inter" },
          ]}
        >
          ¿Ya tienes cuenta?{" "}
          <Text
...
const PasswordScreen = ({
  ...
  setPassword_Confirm_Register,
  openErrorModal,
  setErrorMessage,
}) => {
  const { isKeyboardOpen } = useContext(TecladoContext)
  const shouldShowContinueButton =
    password_register && password_confirm_register
  ...
  const handlePressContinue = () => {
    ...
    if (!passwordRegex.test(password_register)) {
      setErrorMessage(
        "Su contraseña debe contener un número, una mayúscula y al menos 8 caracteres"
      )
      openErrorModal()
      return
    }
    ...
    if (!passwordRegex.test(password_confirm_register)) {
      setErrorMessage(
        "Su contraseña debe contener un número, una maýuscula y al menos 8 caracteres"
      )
      openErrorModal()
      return
    }
  ...
  return (
    <View style={{ alignItems: "center" }}>
      ...
      >
        <Text
          style={[
            styles.seleccioneTextBoth,
            isKeyboardOpen ? styles.seleccioneTextBoth_Keyboard : null,
          ]}
        >
        ...
        <View
          style={[
            styles.textInputRow,
            { marginBottom: 20 },
            isKeyboardOpen ? styles.inputName_keyboard : null,
          ]}
        >
          <View
            style={{
        ...
        {shouldShowContinueButton && (
          <View
            style={[
              styles.bottomContainerEmail,
              isKeyboardOpen ? styles.bottomContainerEmail_keyboard : null,
            ]}
          >
            <TouchableOpacity
              onPress={handlePressContinue}
              style={[
                styles.button,
                { backgroundColor: "rgba(240, 176, 10, 1)" },
    ...
    <View style={{ alignItems: "center" }}>
      ...
      >
        ...
        <View
          style={[
            styles.textInputRow,
            isKeyboardOpen ? styles.inputEmail_keyboard : null,
          ]}
        >
          <TextInput
            style={[
      ...
      >
        ...
        <TouchableOpacity onPress={setToggleModal}>
          ...
          >
            ...
            >
              {date_register
                ? date_register.toLocaleDateString()
                : "DD/MM/YYYY"}
            </Text>
          </View>
        </TouchableOpacity>
  ...
  return (
    <View style={{ alignItems: "center" }}>
      ...
      >
        ...
        >
          Confirma el código que enviamos al email
        </Text>
        <View
          style={[
            styles.textInputRow,
    ...
    <View style={styles.container}>
      ...
      <Modal visible={modalVisible} onRequestClose={() => toggleModalStart()}>
        <View style={styles.modalContainer}>
          <CustomCalendar
            maxMonthsToRender={3}
            setToggleModal={toggleModalStart}
            setDate={setDate_Register}
          ></CustomCalendar>
        </View>
      </Modal>
      <View
        style={[
          ...
          isKeyboardOpen ? styles.headerContainerKeyboard : null,
        ]}
      >
        <ImageBackground
          ...
          style={[
            ...
            ,
            isKeyboardOpen ? styles.backgroundImageKeyboard : null,
          ]}
        >
          <LinearGradient
            colors={[
        ...
        >
          <View style={styles.columnContainer}>
            ...
            {isRegisterPressed && (
              <View
                style={[
                  styles.viewRegisterEmail,
                  isKeyboardOpen ? styles.viewRegisterEmailKeyboard : null,
                ]}
              >
                ...
                >
                  ...
                  >
                    {(props) => (
                      <InitRegister
                        ...
                        verTerminosYPoliticas={verTerminosYPoliticas}
                      />
                    )}
                  </RegisterStack.Screen>
                  <RegisterStack.Screen
                  ...
                  >
                    {(props) => (
                      <EmailScreen
                        ...
                        setEmail_Register={setEmail_Register}
                  ...
                  >
                    {(props) => (
                      <NameScreen
                        ...
                        setName_Register={setName_Register}
                        surname_register={surname_register}
                        setSurName_Register={setSurName_Register}
                        openErrorModal={openErrorModal}
                        setErrorMessage={setErrorMessage}
                      />
                    )}
                  ...
                  >
                    {(props) => (
                      <PasswordScreen
                        ...
                        setPassword_Register={setPassword_Register}
                        password_confirm_register={password_confirm_register}
                        setPassword_Confirm_Register={
                          setPassword_Confirm_Register
                        }
                        openErrorModal={openErrorModal}
                  ...
                  >
                    {(props) => (
                      <DniScreen
                        {...props}
                        dni_register={dni_register}
                        setDniRegister={setDniRegister}
                        openErrorModal={openErrorModal}
                        setErrorMessage={setErrorMessage}
                      />
                    )}
                  ...
                  <RegisterStack.Screen
                    name="CodeEmailScreen"
                    options={{ headerShown: false }}
                  >
                    {(props) => (
                      <CodeEmailScreen
                        {...props}
                        code_email_register={code_email_register}
                        setCodeEmail_Register={setCodeEmail_Register}
                        openErrorModal={openErrorModal}
                        setErrorMessage={setErrorMessage}
                        dni={dni_register}
                        ...
                        name={name_register}
                        lastName={surname_register}
                        date_format={date_register}
                        handleLoginPress={handleLoginPress}
                        setEmail_Login={setEmail_Login}
                        setPassword_Login={setPassword_Login}
                      />
                    )}
                  </RegisterStack.Screen>
                </RegisterStack.Navigator>
