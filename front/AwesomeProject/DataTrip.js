...
const Datatrip = () => {
    ...
    useEffect(() => {
      ...
      const fetchTrips = async () => {
        ...
        const data = [ renderTripButton('Permite mascotas', "huella", false),renderTripButton('No permite mascotas', "huella", true),
        renderTripButton('Prohibido fumar', "smoking", true), renderTripButton('Permite maletas', "suitcase"), renderTripButton('Juan Perez', "circle-check")]
     ...
     <View style={styles.container}>
       <View style={styles.container_trip}>
            <View style={styles.container_header}>
              <TouchableOpacity style={styles.header_chat}>
                <Icon
                  name={'comments-solid'}
                  color={'white'}
                  width={40}
            ...
            <View style={styles.container_profile}>
              <View style={styles.rowProfile}>
                ...
                <View style={styles.columnTripMoney}>
                  <Icon name={"money"} color={'rgb(240, 176, 10)'} width={20} height={20} />
              ...
              <View style={styles.textInputRow}>
                <TouchableOpacity style={styles.button_icon} onPress={decreasePress}>
                  <Text style={styles.button_icon_text}>-</Text>
                </TouchableOpacity>
                <View style={styles.icon_container}>
                  <Icon name={"user-solid"} color={'rgba(204, 204, 204, 0.8)'} width={30} height={'100%'} />
                  <Text style={[styles.icon_text, {color:'rgb(240, 176, 10)'}]}>
                    {asientos}
                  </Text>
                  <Text style={styles.icon_text_2}>
                    /{asientos}
                  </Text>
                </View>
                <TouchableOpacity style={styles.button_icon} onPress={increasePress}>
                  <Text style={styles.button_icon_text}>+</Text>
                </TouchableOpacity>
              </View>
